/**
 * ============================================================================
 * Variables globales y credenciales sensibles (NO ENVIAR AL FRONTEND)
 * ============================================================================
 */
...
const CONFIG = {
  ...
  //Correos que tendrán permisos de "Administrador"
  ADMIN_USERS: ["jhoan.aitan@co.g4s.com", "luis.romero@co.g4s.com"] 
};
// Globales para no romper las funciones de tu código original
